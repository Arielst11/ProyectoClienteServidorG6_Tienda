...
//CLIENTE solo recibe
public class frm_pantalla2 extends javax.swing.JFrame implements Observer{

    private String nombreProductoActual; //necesito saber el anterior
    
    public frm_pantalla2() {
        initComponents();
        this.setLocationRelativeTo(null);
        //que diga cliente conectado
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_pantalla2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_pantalla2().setVisible(true);
            }
        });
    }
    ...
    public void update(Observable o, Object arg) {
        if(arg instanceof String){//quiere decir que esta llegando el valor String 
        ...
        nombreProductoActual= (String) arg;
            ...
            switch (nombreProductoActual) {
                case "aros":
                    this.txt_aros.setText(valor+"");
                    
                    break;
                
                 case "baterias":
                     this.txt_baterias1.setText(valor+"");
                    
                    break;
                
                 case "alternadores":
                     this.txt_alternadores.setText(valor+"");
